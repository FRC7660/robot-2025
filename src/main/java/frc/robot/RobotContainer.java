...
//}
  ...
  private void configurebuttonBox() {
    ...
    buttonBox.axisGreaterThan(0, 0.5).whileTrue(new ElevatorManual(elevator, arm, Constants.Elevator.Direction.UP)); 
    buttonBox.axisLessThan(0, -0.5).whileTrue(new ElevatorManual(elevator, arm, Constants.Elevator.Direction.DOWN)); 
    buttonBox
